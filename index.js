...
module.exports = class Sedb {

	constructor (data) {
		data = data || {};
		this.bucket = data.bucket;
		this.version = data.version;
		this.acl = data.acl || 'private';
		this.parse = data.parse === undefined ? true : data.parse;
		this.encrypt = data.encrypt === undefined ? true : data.encrypt;
		this.decrypt = data.decrypt === undefined ? true : data.decrypt;
		this.stringify = data.stringify === undefined ? true : data.stringify;
		this.s3 = data.s3 === undefined ? new Aws.S3({ apiVersion: this.version }) : data.s3;
	}
