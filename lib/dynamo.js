...
module.exports = class Dynamo {
	...
	table (name) {
		...
		if (!self.tables.has(name)) throw new Error ('Sedb.table - table not defined');
		...
		return Object.defineProperties({}, {
			...
			get: {
				enumerable: true,
				value: self.get.call(self, name)
			},
			put: {
				enumerable: true,
				value: self.put.call(self, name)
			},
			add: {
				enumerable: true,
				value: self.add.call(self, name)
			},
			scan: {
				enumerable: true,
				value: self.scan.call(self, name)
			},
			query: {
				enumerable: true,
				value: self.query.call(self, name)
			},
			update: {
				enumerable: true,
				value: self.update.call(self, name)
			},
			remove: {
				enumerable: true,
				value: self.remove.call(self, name)
			}
		});
	}
